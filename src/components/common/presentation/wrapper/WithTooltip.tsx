...
const WithTooltip: React.FC<ITooltipProps> = ( props ) => {
    ...
    let css = "ToolTip_Text " + ( props.toolTipPosition && (props.forcePosition || !isMobileWidth) ? props.toolTipPosition : "ToolTip_Text_Bottom" ) + " " + ( props.toolTipColor ? props.toolTipColor : "ToolTip_Text_Default" );
    ...
    const childOnTop: boolean = props.toolTipPosition === undefined || (!props.forcePosition && isMobileWidth) || props.toolTipPosition === ToolTipPosition.Bottom || props.toolTipPosition === ToolTipPosition.Right;
    return (
